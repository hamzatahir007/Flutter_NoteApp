...
class NoteDailog extends StatefulWidget {
  final int? noteId;
  final String? title;
  ...
  @override
  State<NoteDailog> createState() => _NoteDailogState();
}

class _NoteDailogState extends State<NoteDailog> {
    ...
    return AlertDialog(
      ...
      actions: [
        TextButton(
          ...
          child: const Text('Cancle', style: TextStyle(color: Colors.black54)),
        ),
        ElevatedButton(
